...
public class RandomDownPolicy : AnimationPropagationPolicy
{
    ...
    {
        transitions.Clear();
        transitions.Add(MoveDirection.LEFT, new List<Vector2> { Vector2.down});
        transitions.Add(MoveDirection.RIGHT, new List<Vector2> { Vector2.down});
        transitions.Add(MoveDirection.UP, new List<Vector2> { Vector2.left, Vector2.right});
        transitions.Add(MoveDirection.DOWN, new List<Vector2> { Vector2.left, Vector2.right});
        ...
        while (true)
        {
            ...
            else
            {
                ...
                float turnProbability = (currentDirection == MoveDirection.DOWN) ? GlobalReferencesHolder.TurnProbability : 1f - GlobalReferencesHolder.TurnProbability;
