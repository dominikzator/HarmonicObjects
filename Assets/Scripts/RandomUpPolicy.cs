...
public class RandomUpPolicy : AnimationPropagationPolicy
{
    ...
    {
        transitions.Clear();
        transitions.Add(MoveDirection.LEFT, new List<Vector2> { Vector2.up});
        transitions.Add(MoveDirection.RIGHT, new List<Vector2> { Vector2.up});
        ...
        while (true)
        {
            ...
            else
            {
                ...
                float turnProbability = (currentDirection == MoveDirection.UP) ? GlobalReferencesHolder.TurnProbability : 1f - GlobalReferencesHolder.TurnProbability;
